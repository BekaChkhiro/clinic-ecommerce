...
- **Description**:
  ...
  - Keep Promotion module (needed for discounts)
  - Disable Inventory module (stock from APEX ERP)
  - Disable Stock Location module (single store)
  - Configure medusa-config.ts with required modules
  - Note: Gift Card module არ არსებობს Medusa 2.0-ში
